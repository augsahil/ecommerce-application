                    ...
                    <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
                      <div className="p-10 flex-1 space-y-8">
                        <div className="space-y-4">
                          <h2 className="text-xl font-semibold text-gray-900 dark:222text-white">
                            Delivery Details
                          </h2>
                          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                              <label
                                htmlFor="your_name"
                                className="mb-2 block text-sm font-medium text-gray-900 dark:222text-white"
                              >
                                {' '}
                                Your name{' '}
                              </label>
                            ...
                            <div className="col-span-2  w-full">
                              {user &&
                                user.address &&
                                user.address.map((cur, i) => {
                                  return (
                                    <div
                                      onClick={() => {
                                        setFieldValue('address', cur._id);
                                      }}
                                      className="w-full border border-gray-300 bg-gray-50 py-4 mb-3 px-4 rounded-xl flex items-center justify-between"
                                      key={i}
                                    >
                                      <div className="flex flex-col">
                                        ...
                                        <p className="text-xl text-zinc-600">{`  ${cur.landmark} ${cur.city} ${cur.state} ${cur.country}-${cur.pin_code}`}</p>
                                      </div>
                                      <span
                                        className={clsx(
                                          'w-8 h-8 rounded-full ',
                                          cur._id == values.address
                                            ? 'bg-blue-500 p-1 outline-2 outline-blue-500 border-2 border-white'
                        ...
                        <div className="flow-root">
                          <div className="-my-3 divide-y divide-gray-200 dark:222divide-gray-800">
                            <dl className="flex items-center justify-between gap-4 py-3">
                              <dt className="text-base font-normal text-gray-500 dark:222text-gray-400">
                                View Cart
                              </dt>
                            ...
                            <dl className="flex items-center justify-between gap-4 py-3">
                              <dt className="text-base font-bold text-gray-900 dark:222text-white">
                                Total
                              </dt>
                              <dd className="text-base font-bold text-gray-900 dark:222text-white">
                                &#8377;{cartData.total}
                              </dd>
                            </dl>
                            <dl className="w-full">
                              <button
                                type="submit"
                                className="py-2 text-white rounded-md text-center w-full bg-blue-500"
                              >
                                Pay
                              </button>
                            </dl>
